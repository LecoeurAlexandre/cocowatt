...
public class TripController {
    ...
    @PostMapping("")
    public ResponseEntity post(@RequestParam String startingPoint, @RequestParam String endPoint, @RequestParam String startingTime, @RequestParam int availableSeats, @RequestParam int distance, @RequestParam int userId) {
        try {
            tripService.create(startingPoint, endPoint, startingTime,availableSeats, distance, userId);
