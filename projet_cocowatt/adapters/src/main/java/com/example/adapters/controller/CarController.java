...
public class CarController {
    ...
    @PostMapping("")
    public ResponseEntity post(@RequestParam String brand, @RequestParam String model, @RequestParam int availableSeats, @RequestParam boolean isElectric, @RequestParam int userId) {
        try {
            carService.createCar(brand, model, availableSeats, isElectric, userId);
        } catch (Exception e) {
